...
const en: Dict = {
  ...
  heroPill: "Halal Sales Training · By Muslims, For Muslims",
  heroTitleA: "HALAL", heroTitleB: "SALES", heroTitleC: "BARAKAH", heroTitleD: "BUSINESS",
  heroSub: "As-salamu alaykum. Learn ethical sales and business the halal way — with sidq, amanah, and zero riba. Free lessons, live coaching, and a global ummah of closers.",
  tiersEyebrow: "Two Halal Paths", tiersTitle: "Pick your path, insha'Allah",
  starterTitle: "Starter", starterPrice: "Halal sales fundamentals — $0 forever.", getFree: "Get Free Access",
  ...
  teamEyebrow: "The Team", teamTitle: "A team of Muslims teaching Muslims", teamSub: "Afnan leads, but a full team of coaches, a Shariah advisor, and operators helps every student.",
  chatEyebrow: "Ask Anything", chatTitle: "Talk to the Academy AI", chatSub: "Instant answers on halal sales, our programs, or how to invest.",
  chatPlaceholder: "Ask a question about sales, the course, or investing…", chatSend: "Send",
  chatGreeting: "As-salamu alaykum — I'm the Afnan Sales Academy assistant. Ask me anything about halal sales, our courses, or investing in the business.",
  investEyebrow: "Investors", investTitle: "Invest in Afnan Sales Academy",
  investSub: "Insha'Allah we're growing fast. We welcome Muslim angels and strategic partners on a riba-free structure.",
  ...
  joinEyebrow: "Contact your regional instructor", joinTitle: "Bismillah — let's begin",
  joinSub: "Choose your plan and your regional instructor will personally send you the next steps.",
  joinFree: "Free Starter", joinPro: "Pro Mentorship",
...
const ar: Dict = {
  ...
  joinFree: "المبتدئ المجاني", joinPro: "الإرشاد الاحترافي",
